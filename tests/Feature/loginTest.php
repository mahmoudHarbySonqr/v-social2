...
class loginTest extends TestCase {
    ...
    public function testLoginBaseApi( ) {
        ...
        ;
        $this
            -> postJson( route( 'api.v1.auth.login' ) , [ 'phone' => $this -> faker( ) -> unique( ) -> phoneNumber ( ) ])
            -> AssertStatus( Response::HTTP_UNPROCESSABLE_ENTITY )
            -> assertExactJson( [
                'message' => 'The given data was invalid.' ,
                'errors' => [
        ...
        ;
        $this
            -> postJson( route( 'api.v1.auth.login' ) , [ 'email' => $this -> faker( ) -> unique( ) -> safeEmail ( ) ])
            -> AssertStatus( Response::HTTP_UNPROCESSABLE_ENTITY )
            -> assertExactJson( [
                'message' => 'The given data was invalid.' ,
                'errors' => [
        ...
        ;
        $this
            -> postJson( route( 'api.v1.auth.login' ) , [ 'email' => ( $user = User::Factory( ) -> create( ) ) -> email ])
            -> AssertStatus( Response::HTTP_UNPROCESSABLE_ENTITY )
            -> assertExactJson( [
                'message' => 'The given data was invalid.' ,
                'errors' => [
